...
#CONFIGURAÇÃO
quantia_para_teste = 20

dataset_original = url + "Iris.csv" 
dataset_binarizado = url + "Iris_binarizado.csv"
dataset_binarizado_amostras = url + "Iris_binarizado_amostras.csv"

coluna_target = "Species"

argumentos_iris = url + 'iris_argumentos.ob'
...
import pickle
with open(argumentos_iris, 'rb') as fp:
