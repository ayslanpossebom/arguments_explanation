...
#CONFIGURAÇÃO
quantia_para_teste = 40




dataset_original = url + "breast-cancer.csv" 
dataset_binarizado = url + "titanic_test_binarizado.csv"
dataset_binarizado_amostras = url + "titanic_train_binarizado_amostras.csv"
coluna_target = "Survived"

argumentos_titanic = url + 'titanic_argumentos.ob'


dataset_TESTE = url + "titanic_test_binarizado.csv"
...
import pickle
with open(argumentos_titanic, 'rb') as fp:
...
accuracy = accuracy_score(fim["CORRETO"], fim["árvore"])
print("Acurácia da árvore de decisão: ", accuracy)

print("Acurácia da contagem: ", (argumentosJustificaveis.quantia_classificada_correto/len(df_temp)))