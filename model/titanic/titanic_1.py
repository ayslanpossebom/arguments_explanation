...
def computarArgumentos(df, coluna_target, quantia_para_teste=0):
    ...
    import pickle
    with open(argumentos_titanic, 'wb') as fp:
...
"""
Treinamento com todas as linhas do dataset de amostras completo
Total de argumentos válidos:  634
Total de argumentos inválidos:  18721
"""